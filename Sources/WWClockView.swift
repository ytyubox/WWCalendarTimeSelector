...
internal class WWClock: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if time.hour < 12 {
            ...
            var str = NSAttributedString(string: "AM", attributes: [NSAttributedString.Key.font: fontAMPMHighlight, NSAttributedString.Key.foregroundColor: fontColorAMPMHighlight, NSAttributedString.Key.paragraphStyle: paragraph].compactMapValues{$0})
            ...
            str = NSAttributedString(string: "PM", attributes: [NSAttributedString.Key.font: fontAMPM, NSAttributedString.Key.foregroundColor: fontColorAMPM, NSAttributedString.Key.paragraphStyle: paragraph].compactMapValues{$0})
            ...
            var str = NSAttributedString(string: "AM", attributes: [NSAttributedString.Key.font: fontAMPM, NSAttributedString.Key.foregroundColor: fontColorAMPM, NSAttributedString.Key.paragraphStyle: paragraph].compactMapValues{$0})
            var ampmHeight = fontAMPM.lineHeight
            str.draw(in: CGRect(x: amX, y: ampmY + (ampmSize - ampmHeight) / 2, width: ampmSize, height: ampmHeight))
            str = NSAttributedString(string: "PM", attributes: [NSAttributedString.Key.font: fontAMPMHighlight, NSAttributedString.Key.foregroundColor: fontColorAMPMHighlight, NSAttributedString.Key.paragraphStyle: paragraph].compactMapValues{$0})
            ampmHeight = fontAMPMHighlight.lineHeight
            str.draw(in: CGRect(x: pmX, y: ampmY + (ampmSize - ampmHeight) / 2, width: ampmSize, height: ampmHeight))
        }
        
        if showingHour {
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontHour, NSAttributedString.Key.foregroundColor: fontColorHour, NSAttributedString.Key.paragraphStyle: paragraph].compactMapValues{$0}
            let textAttrHighlight : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontHourHighlight, NSAttributedString.Key.foregroundColor: fontColorHourHighlight, NSAttributedString.Key.paragraphStyle: paragraph].compactMapValues{$0}
            ...
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontMinute, NSAttributedString.Key.foregroundColor: fontColorMinute, NSAttributedString.Key.paragraphStyle: paragraph].compactMapValues{$0}
